...
- **Python yfinance v1.5.2 Parity**: Fundamentals-timeseries valuation measures, subscriptions-based login checks, chunked fundamentals fallback, ETFQuery screeners, and hardened price repair
